...
export default function LoginApproved() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-blue-500 to-purple-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white/95 backdrop-blur rounded-2xl shadow-xl p-8">
        ...
        <p className="text-center text-sm text-gray-500 mt-1">Manage your business with the Nexa AI Engine</p>
