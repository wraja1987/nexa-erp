...
async function getData() {
  const res = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || ""}/api/finance/reports/ap-ar/receivables-aging`, { cache: "no-store" });
